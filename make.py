...
@depends_on('compile')
def publish(conf):
    run_program('scp', [ 'bin/thesis.pdf', 'philiparvidsson.com:/home/philip/philiparvidsson.com/static/thesis.pdf'  ])
...
def bibtex(conf):
    ...
    bibmtime = os.path.getmtime(os.path.join(conf.srcdir, 'biblio.bib'))
