...
Past attempts have approached the problem with algorithms that are not designed specifically to handle sequential datasets and instead assume that the data points are IID (Independent and Identically Distributed). Time series sequences have a temporal component dictating their intradependence and distribution within the dataset, where each element in the sequence is somehow correlated to previous (with respect to time) elements through a variety of factors.
